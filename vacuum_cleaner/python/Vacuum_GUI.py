...
class Vacuum_GUI:
    ...
    def setup_ui_layout(self):
        ...
        self.algo_var = tk.StringVar(value="BFS_1")
        algos = [("BFS 1", "BFS_1"), ("BFS 2", "BFS_2"), 
                 ("DFS 1", "DFS_1"), ("DFS 2", "DFS_2")]
        
        for text, val in algos:
            rb = tk.Radiobutton(algo_frame, text=text, variable=self.algo_var, value=val, 
                                bg=self.BG_PANEL, fg=self.TEXT_MUTED, selectcolor=self.BG_CARD, 
                                activebackground=self.BG_PANEL, activeforeground=self.CYAN,
    ...
    def start_search(self):
        ...
        self.log_msg(f"Bắt đầu tìm kiếm bằng thuật toán {algo}...")
